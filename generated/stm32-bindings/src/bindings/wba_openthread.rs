...
pub const OPENTHREAD_API_VERSION: u32 = 578;
...
pub const OT_STEERING_DATA_MIN_LENGTH: u32 = 1;
...
pub type otMessageTxCallback = ::core::option::Option<
    unsafe extern "C" fn(
        aMessage: *const otMessage,
        aError: otError,
        aContext: *mut ::core::ffi::c_void,
...
pub struct otMessageQueue {
    ...
    #[doc = "< Opaque data used by the implementation."]
    pub mData2: *mut ::core::ffi::c_void,
}
...
#[doc = "< Key Type: Derive."]
pub const otCryptoKeyType_OT_CRYPTO_KEY_TYPE_DERIVE: otCryptoKeyType = 4;
...
#[doc = "< Key Algorithm: HKDF SHA-256."]
pub const otCryptoKeyAlgorithm_OT_CRYPTO_KEY_ALG_HKDF_SHA256: otCryptoKeyAlgorithm = 4;
...
#[doc = "< Key Usage: Derive."]
pub const OT_CRYPTO_KEY_USAGE_DERIVE: _bindgen_ty_1 = 32;
...
#[doc = "< meshcop Duration TLV"]
pub const otMeshcopTlvType_OT_MESHCOP_TLV_DURATION: otMeshcopTlvType = 23;
...
#[doc = "< meshcop Admitter State TLV"]
pub const otMeshcopTlvType_OT_MESHCOP_TLV_ADMITTER_STATE: otMeshcopTlvType = 90;
#[doc = "< meshcop Enroller ID TLV"]
pub const otMeshcopTlvType_OT_MESHCOP_TLV_ENROLLER_ID: otMeshcopTlvType = 91;
#[doc = "< meshcop Enroller Mode TLV"]
pub const otMeshcopTlvType_OT_MESHCOP_TLV_ENROLLER_MODE: otMeshcopTlvType = 92;
...
#[doc = "< meshcop Joiner Advertisement TLV (experimental)"]
...
#[doc = " Callback function pointer to notify the application of a received UDP message on a UDP socket.\n\n This callback does not transfer ownership of @p aMessage. The callback implementation must not modify the message\n content. The message is guaranteed to be valid only within the context of the callback.\n\n @param[in] aContext      A pointer to the application-specific context.\n @param[in] aMessage      A pointer to the received UDP message.\n @param[in] aMessageInfo  A pointer to the IPv6 message info structure."]
